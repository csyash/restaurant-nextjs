...
export const pastas: Products = [
  {
    ...
    desc: 'Classic spaghetti with hearty Bolognese sauce made from ground beef, tomatoes, and aromatic herbs.',
    img: '/temporary/pasta1.png',
    price: 18.9,
    options: [
      { title: 'Small', additionalPrice: 0 },
      { title: 'Regular', additionalPrice: 3 },
  ...
  },
  {
    ...
    desc: 'Rich and creamy Alfredo sauce tossed with fettuccine pasta for a luxurious and indulgent dining experience.',
  ...
  },
  {
    ...
    desc: 'Penne pasta in a spicy Arrabiata sauce featuring tomatoes, garlic, and red chili flakes.',
    img: '/temporary/pasta3.png',
    price: 20.9,
    options: [
      { title: 'Small', additionalPrice: 0 },
      { title: 'Regular', additionalPrice: 3 },
  ...
  },
  {
    ...
    desc: 'Delicious ravioli filled with a creamy carbonara filling, topped with crispy bacon and Parmesan cheese.',
    img: '/temporary/pasta4.png',
    price: 24.9,
    options: [
      { title: 'Small', additionalPrice: 0 },
      { title: 'Regular', additionalPrice: 3 },
